...
execute as @a[scores={actionbar_tick=1..}] run title @s actionbar [{"text":"You have a pending gift! Use ","color":"gold"},{"text":"/trigger open_gift","color":"white"},{"text":" to open it!","color":"gold"}]
...
execute as @a[scores={actionbar_tick=1..}] run schedule function gift_player:pending_gift 1t replace